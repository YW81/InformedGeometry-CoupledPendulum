function coeffs = transformJointDifference(data,row_tree,col_tree)
% Gal Mishne, 2016
...
row_avg_mat = transformDifferencesMatrix(row_tree);
coeffs = row_avg_mat * data;
col_avg_mat = transformDifferencesMatrix(col_tree);
